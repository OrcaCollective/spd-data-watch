...
class Regexps:
  ...
  CCS_URL = "https://www.seattle.gov/Documents/Departments/OPA/ClosedCaseSummaries/\\d{4}OPA-\\d{4}ccs\\d{6}.pdf"
  SERIAL = "\\d{1,4}"
  STRING = "[\\w \\-,]{1,255}"
...
def validate(s, pattern, default) -> str:
  """
  Tries to validate a string against a pattern and returns a default value if validation fails.
  """
